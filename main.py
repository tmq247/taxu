...
API_KEY = '6444324312:AAEaTshkVpJSXDY_MSWlzUHX3VPPyN6Baf8'
# Khởi tạo bot
...
group_chat_id2 = "-1001930119529"  # Replace with your second group chat ID
# Định nghĩa id của nhóm mà bạn muốn gửi thông báo
group_chat_id = '-1001906985248'
...
admin_user_id = 5404649016  # Replace with the actual admin user ID

@bot.message_handler(commands=['regcode'])
def create_gitcode_handler(message):
    # Check if the user is the admin
    if message.from_user.id == 5404649016:
...
def set_balance(msg):
  if msg.from_user.id == 5404649016:
    bot.reply_to(msg, """
...
"""
    ...
    group_chat_id = -1001906985248  # Thay thế bằng ID thực sự của nhóm chat
...
"""
    ...
    # Gửi thông báo đến nhóm về việc có người chơi đặt cược
    group_chat_id = -1001906985248  # Replace with the actual group chat ID
...
➤Về {account_type}: {account_info}
        """
    another_bot_token = "6564166594:AAFNORBdfC_FQr440dd6oBoLgr9ITw1uN8s"
    another_bot_chat_id = "5404649016"
    requests.get(
